...
//                System.out.println("current filename : "+"%EB%AC%B4%EB%A3%8C%EB%B0%B0%EC%86%A1.jpg");
//
//                String decodeResult = URLDecoder.decode("%EB%AC%B4%EB%A3%8C%EB%B0%B0%EC%86%A1.jpg","UTF-8");
//
//                System.out.println("iso-8859-1 decoded : "+ URLDecoder.decode("%EB%AC%B4%EB%A3%8C%EB%B0%B0%EC%86%A1.jpg","iso-8859-1"));
//
//                System.out.println("EUC-KR decoded : " + URLDecoder.decode("%EB%AC%B4%EB%A3%8C%EB%B0%B0%EC%86%A1.jpg","EUC-KR"));
//
//                System.out.println("utf-8 decode result : "+ decodeResult);
//
//                String euckrEncodeResult = URLEncoder.encode(decodeResult, "EUC-KR");
//
//                System.out.println("euc-kr encoding result : " + euckrEncodeResult);
//
//                String doubleEncoded = URLEncoder.encode("%EB%AC%B4%EB%A3%8C%EB%B0%B0%EC%86%A1.jpg","UTF-8");
//                String doubleEncoded2 = URLEncoder.encode("%EB%AC%B4%EB%A3%8C%EB%B0%B0%EC%86%A1.jpg","EUC-KR");
//
//                System.out.println("double encoded utf-8 : "+ doubleEncoded);
//                System.out.println("double encoded euc-kr : "+ doubleEncoded2);
